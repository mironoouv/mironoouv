...
<p align="center">
  Разрабатываю <b>VoidRP</b> — моддовый Minecraft RP-сервер с полноценной
  веб-платформой, собственным лаунчером и серверными модами.
</p>
...
- **Бэкенд** — FastAPI · SQLAlchemy 2.0 · PostgreSQL · Alembic
- **Фронтенд** — Vue 3 · Vite · Tailwind CSS
- **Десктоп** — Electron · .NET 8 лаунчер
- **Minecraft** — моды и плагины NeoForge & Paper (Java · Kotlin)
